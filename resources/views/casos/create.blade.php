...
<head>
    ...
    <title>Crear Nuevo Caso - Te Apoyamos S.A.S.</title>
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Crear Nuevo Caso</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <!-- Formulario para crear un caso -->
                        <form action="{{ route('casos.store') }}" method="POST">
                            @csrf

                            <!-- Campo: Código del caso (generado automáticamente, solo lectura) -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="abogado_asignado" name="abogado_asignado" required>
                                    ...
                                    <option value="Dr. María González" {{ old('abogado_asignado') == 'Dr. María González' ? 'selected' : '' }}>Dr. María González</option>
                                    <option value="Dr. Carlos Ruiz" {{ old('abogado_asignado') == 'Dr. Carlos Ruiz' ? 'selected' : '' }}>Dr. Carlos Ruiz</option>
                                    <option value="Dr. Laura Torres" {{ old('abogado_asignado') == 'Dr. Laura Torres' ? 'selected' : '' }}>Dr. Laura Torres</option>
                                    <option value="Dr. Ana Martínez" {{ old('abogado_asignado') == 'Dr. Ana Martínez' ? 'selected' : '' }}>Dr. Ana Martínez</option>
                                    <option value="Dr. Pedro Sánchez" {{ old('abogado_asignado') == 'Dr. Pedro Sánchez' ? 'selected' : '' }}>Dr. Pedro Sánchez</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tipo_proceso" name="tipo_proceso" required>
                                    ...
                                    <option value="Divorcio" {{ old('tipo_proceso') == 'Divorcio' ? 'selected' : '' }}>Divorcio</option>
                                    <option value="Contrato de Compraventa" {{ old('tipo_proceso') == 'Contrato de Compraventa' ? 'selected' : '' }}>Contrato de Compraventa</option>
                                    <option value="Herencia" {{ old('tipo_proceso') == 'Herencia' ? 'selected' : '' }}>Herencia</option>
                                    <option value="Testamento" {{ old('tipo_proceso') == 'Testamento' ? 'selected' : '' }}>Testamento</option>
                                    <option value="Pensión Alimenticia" {{ old('tipo_proceso') == 'Pensión Alimenticia' ? 'selected' : '' }}>Pensión Alimenticia</option>
                                    <option value="Sucesión" {{ old('tipo_proceso') == 'Sucesión' ? 'selected' : '' }}>Sucesión</option>
                                    <option value="Contrato de Arrendamiento" {{ old('tipo_proceso') == 'Contrato de Arrendamiento' ? 'selected' : '' }}>Contrato de Arrendamiento</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="cliente_id" name="cliente_id" required>
                                    ...
                                    @foreach(\App\Models\User::all() as $user)
                                        <option value="{{ $user->id }}" {{ old('cliente_id') == $user->id ? 'selected' : '' }}>
